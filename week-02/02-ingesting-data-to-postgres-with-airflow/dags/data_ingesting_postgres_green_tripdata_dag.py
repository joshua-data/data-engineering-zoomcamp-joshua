...
from ingest_green_tripdata import save_to_csv, load_to_postgres
...
INPUT_FNAME_RAW = 'green_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}'
...
OUTPUT_FNAME_PARQUET = 'output_green_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
...
PG_TABLE_NAME = 'green_taxi_trips_{{ execution_date.strftime(\'%Y_%m\') }}'
...
with DAG(
    dag_id="data_ingesting_postgres_green_tripdata_dag",
