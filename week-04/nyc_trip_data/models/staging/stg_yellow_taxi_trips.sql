...
CTE_raw AS (
    ...
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_01') }}
    WHERE 
    ...
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_02') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_03') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_04') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_05') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_06') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_07') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_08') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_09') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_10') }}
    WHERE 
        "VendorID" IS NOT NULL
    UNION ALL
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY "VendorID", tpep_pickup_datetime) AS row_num
    FROM 
        {{ source('yellow_taxi_trips', 'm2024_11') }}
    WHERE 
        "VendorID" IS NOT NULL
)
